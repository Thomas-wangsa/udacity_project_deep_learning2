...
def parse_args():
    ...
    parser.add_argument('--checkpoint', action='store', default='checkpoint2.pth')
    parser.add_argument('--top_k', dest='top_k', default='5')
    parser.add_argument('--filepath', dest='filepath', default='flowers/test/1/image_06752.jpg') # use a deafault filepath to a primrose image 
